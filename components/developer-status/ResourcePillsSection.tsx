    ...
    <section className="border-b border-ink/10 bg-white py-4">
      <Container>
        <ul className="flex flex-wrap items-center gap-2.5">
          ...
          <li className="inline-flex rounded-full border border-ink/10 bg-surface px-4 py-2 text-xs font-medium text-slate-600">
            Changelog <span className="ml-1 text-accent-amber">· NOT RELEASED</span>
          </li>
        </ul>
      </Container>
    </section>
