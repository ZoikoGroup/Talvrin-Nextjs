  ...
  return (
    <section className="relative overflow-hidden bg-ink py-20 sm:py-28">
      ...
      <Container className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,440px)] lg:gap-12 xl:grid-cols-[minmax(0,720px)_minmax(0,494px)] xl:justify-between">
        <div>
          <Reveal>
            <SectionEyebrow tone="amber">Talvrin Press and Media</SectionEyebrow>
          </Reveal>

          <Reveal delay={0.1}>
            <h1 className="mt-5 text-4xl font-bold leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-[56px]">
              Talvrin Press and Media
            </h1>
          </Reveal>

          <Reveal delay={0.2}>
            <p className="mt-5 max-w-[720px] text-lg leading-8 text-white/90">
              Verified information and approved resources for journalists, editors, analysts,
          ...
          >
            <LinkButton href="#media-enquiry" variant="onDark">
          ...
          <Reveal delay={0.4}>
            <Link
              href="#resources"
              className="mt-5 inline-block text-sm font-semibold text-white/60 transition-colors hover:text-white"
            >
        ...
        >
          <Image
            src="/images/company/press-media/press-media-hero-interview.webp"
            alt="Journalist holding a microphone toward an interviewee"
            fill
            priority
