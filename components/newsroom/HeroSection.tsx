  ...
  return (
    <section className="relative overflow-hidden bg-ink py-20 sm:py-28">
      ...
      <Container className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,440px)] lg:gap-12 xl:grid-cols-[minmax(0,720px)_minmax(0,494px)] xl:justify-between">
        <div>
          <Reveal>
            <SectionEyebrow tone="amber">Talvrin Newsroom</SectionEyebrow>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <p className="mt-6 max-w-[720px] text-lg leading-8 text-white/90">
              Verified updates and source-linked perspectives on Talvrin, public-market research,
              evidence, monitoring, and trust.
            </p>
          </Reveal>
          ...
          >
            <LinkButton href="#all-publications" variant="onDark">
              View Publications
            </LinkButton>
            <Link
        ...
        >
          <Image
            src="/images/company/newsroom/newsroom-hero-briefing.webp"
            alt="Three colleagues reviewing updates together at a desk"
            fill
            priority
